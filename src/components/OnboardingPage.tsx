      ...
      <div className="w-full max-w-lg">
        ...
        {step === 0 && (
          <div className="mb-6 p-4 rounded-xl bg-[var(--warning)]/8 border border-[var(--warning)]/15 text-sm text-[var(--text-muted)]">
            Clank can read, write, and delete files, and execute commands.
          ...
          <div className="space-y-5">
            ...
            {telegramEnabled && (
              <div className="space-y-3 pl-1">
                ...
                />
                <p className="text-xs text-[var(--text-dim)]">
                  Start the bot with <code className="px-1.5 py-0.5 rounded bg-[var(--bg-elevated)] text-[var(--text-muted)]">clank --telegram</code>
                </p>
              </div>
            )}
          </div>
