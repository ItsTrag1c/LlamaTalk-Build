...
var import_fs3, import_path4, import_os2, INSTRUCTION_FILENAMES, LEGACY_INSTRUCTION_FILENAMES;
...
var init_search_files = __esm({
  "../../llamatalkbuild-engine/src/tools/search-files.js"() {
    ...
    BINARY_EXTENSIONS2 = /* @__PURE__ */ new Set([".png", ".jpg", ".jpeg", ".gif", ".bmp", ".ico", ".svg", ".woff", ".woff2", ".ttf", ".eot", ".mp3", ".mp4", ".avi", ".zip", ".tar", ".gz", ".exe", ".dll", ".so", ".dylib", ".pdf", ".lock"]);
    searchFilesTool = {
      definition: {
        name: "search_files",
...
var init_generate_file = __esm({
  "../../llamatalkbuild-engine/src/tools/generate-file.js"() {
    ...
    init_base2();
    init_safety();
    SUPPORTED_TYPES = ["md", "txt", "html", "csv", "json", "xml", "yaml", "yml", "log", "pdf"];
    generateFileTool = {
      definition: {
        name: "generate_file",
  ...
  "../../llamatalkbuild-engine/src/tools/delegate-agent.js"() {
    ...
    delegateAgentTool = {
      ...
      async execute(args, context) {
        ...
        const agents = config2.subAgents || [];
...
${taskBlock}` : taskBlock;
        ...
        while (iterationCount < maxIter) {
          const systemPrompt = buildSystemPrompt(this.config, this.projectRoot, memoryBlock, this.projectContext, this.agentMode, {
            agentName: this.subAgentDef?.name || this.config.agentName || void 0,
            agentRole: this.subAgentDef?.role || void 0,
